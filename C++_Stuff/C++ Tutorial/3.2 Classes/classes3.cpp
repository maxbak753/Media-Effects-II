...
class Player { // definition & declaration at top unless in a multi-file program
    public: // ACCESS SPECIFIER
        ...
        string gamerTag;
        int score;
        int *attack = (int*)malloc(sizeof(int)); // write a free() every time you write a malloc()!
        ...
        // DECONTRUCTOR (use ~ in front of class name)
        // - runs when class is destroyed
        ~Player() {
            cout << "Decontructor ran" << endl;
            free(attack); // write a free() every time you write a malloc()!
        }
